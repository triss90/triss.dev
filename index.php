    ...
    <section id="work" tabindex="-1">
        ...
        <div class="work-items" id="scroll-highlighted" role="region" aria-label="gallery" tabindex="0">
            ...
            <div class="work-item">
                ...
                <svg class="work-item-image webbox" width="239px" height="132px" viewBox="0 0 239 132" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                <p class="work-item-description">A curated list of web-, network-, design-, and security tools.</p>
            ...
            <div class="work-item">
                ...
                <p class="work-item-description">Cloudservers A/S high performance cloudservers are perfect for everything from web-apps and development to large enterprise RDS environments.</p>
